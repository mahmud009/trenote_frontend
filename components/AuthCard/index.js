...
import { Box, Text, Link, Button, Image, Flex } from "@chakra-ui/react";
    ...
    <Flex h="full" direction="column" justify="center">
      ...
      <Box mt="60px">
        <Text color="brand_gray.400" fontSize="16px">
          ...
          . Make sure that you read our privacy policy and terms service before
          signing up to the trenote.
        </Text>
      </Box>
    </Flex>
  );
